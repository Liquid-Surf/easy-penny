  ...
  return (
    <>
      <Modal
        ...
        overlayClassName={{
          base: "transition-opacity duration-1000 motion-safe:opacity-0 bg-opacity-90 bg-gray-900 p-5 md:py-20 md:px-40 lg:px-60 xl:px-96 fixed top-0 left-0 right-0 bottom-0 overscroll-contain",
          afterOpen: "motion-safe:opacity-100",
          beforeClose: "",
        }}
        className={{
          base: "transition-opacity duration-1000 motion-safe:opacity-0 bg-white shadow-lg mx-auto p-5 md:p-10 rounded-lg",
          afterOpen: "motion-safe:opacity-100",
          beforeClose: "",
        }}
        closeTimeoutMS={1000}
